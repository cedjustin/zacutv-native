...
export default class TvShow extends React.Component {
    ...
    //fetching data
    fetchData = async()=>{
        const shortMoviesJson = await fetch(this.state.rootUrl+'/api/short-movies/'+this.state.offSet,{
            method:'GET',
            headers:{
        ...
        const shortMoviesResponse = await shortMoviesJson.json();
        this.setState({shortMoviesData:shortMoviesResponse});
  ...
  //passing and navigating to details page
    ...
    _loadMore = async()=>{
        ...
        const moviesJson = await fetch(this.state.rootUrl+'/api/short-movies/'+this.state.offSet,{
            method:'GET',
            headers:{
                appId:this.state.appId,
                appKey:this.state.appKey
        ...
        this.setState({
            shortMoviesData: [...this.state.shortMoviesData, ...moviesResponse]
        });
    }
